...
std::unique_ptr<Scene> supporttravel(std::string filename, std::shared_ptr<camera> cam) {
	std::ifstream file;
	file.open(filename + "-0.curves");
	std::vector<std::shared_ptr<tinyspline::BSpline>> splines_0 = util::read_splines(file, '#');
	file.close();
...
std::unique_ptr<Scene> supportarrive(std::string filename, std::shared_ptr<camera> cam) {
	std::ifstream file;
	file.open(filename + "-0.curves");
	std::vector<std::shared_ptr<tinyspline::BSpline>> splines_0 = util::read_splines(file, '#');
	file.close();
	...
	file.open(filename + "-3.curves");
	std::vector<std::shared_ptr<tinyspline::BSpline>> splines_3 = util::read_splines(file, '#');
	file.close();
	...
	file.open(filename + "-3.actions");
	std::vector<float> actions_3 = util::read_floats(file, '#');
	file.close();
	...
	objs.emplace_back(std::make_unique<Object>(
		Globals::support,
		splines_3[0], splines_3[1], std::vector{
			splines_3[2],
			splines_3[3]
		},
		std::vector<std::shared_ptr<ObjectAction>>{
...
std::unique_ptr<Scene> supportkill(std::string filename, std::shared_ptr<camera> cam) {
	std::ifstream file;
	file.open(filename + "-0.curves");
	std::vector<std::shared_ptr<tinyspline::BSpline>> splines_0 = util::read_splines(file, '#');
	file.close();
	...
	objs.emplace_back(std::make_unique<Object>(
		...
		std::vector<std::shared_ptr<ObjectAction>>{
			std::make_shared<LaserAction>(0.5, 1, actions_1[0], actions_1[1], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[2], actions_1[3], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[4], actions_1[5], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[6], actions_1[7], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[8], actions_1[9], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[10], actions_1[11], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[12], actions_1[13], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[14], actions_1[15], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[16], actions_1[17], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[18], actions_1[19], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[20], actions_1[21], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[22], actions_1[23], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[24], actions_1[25], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[26], actions_1[27], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[28], actions_1[29], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[30], actions_1[31], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_1[32], actions_1[33], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_1[34], actions_1[35], Globals::pirate_laser_origin_right, c2, 2500),
	...
	objs.emplace_back(std::make_unique<Object>(
		...
		std::vector<std::shared_ptr<ObjectAction>>{
			std::make_shared<LaserAction>(0.5, 1, actions_2[0], actions_2[1], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[2], actions_2[3], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[4], actions_2[5], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[6], actions_2[7], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[8], actions_2[9], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[10], actions_2[11], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[12], actions_2[13], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[14], actions_2[15], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[16], actions_2[17], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[18], actions_2[19], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[20], actions_2[21], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[22], actions_2[23], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[24], actions_2[25], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[26], actions_2[27], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[28], actions_2[29], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[30], actions_2[31], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_2[32], actions_2[33], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_2[34], actions_2[35], Globals::pirate_laser_origin_right, c2, 2500),
	...
	objs.emplace_back(std::make_unique<Object>(
		...
		std::vector<std::shared_ptr<ObjectAction>>{
			std::make_shared<LaserAction>(0.5, 1, actions_3[0], actions_3[1], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[2], actions_3[3], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[4], actions_3[5], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[6], actions_3[7], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[8], actions_3[9], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[10], actions_3[11], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[12], actions_3[13], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[14], actions_3[15], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[16], actions_3[17], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[18], actions_3[19], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[20], actions_3[21], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[22], actions_3[23], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[24], actions_3[25], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[26], actions_3[27], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[28], actions_3[29], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[30], actions_3[31], Globals::pirate_laser_origin_right, c2, 2500),
			std::make_shared<LaserAction>(0.5, 1, actions_3[32], actions_3[33], Globals::pirate_laser_origin_left, c2, 2500),
			std::make_shared<LaserAction>(0.2, 1, actions_3[34], actions_3[35], Globals::pirate_laser_origin_right, c2, 2500),
