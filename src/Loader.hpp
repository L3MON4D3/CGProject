...
std::unique_ptr<Scene> supportkill(std::string filename, std::shared_ptr<camera> cam) {
	...
	objs.emplace_back(std::make_unique<Object>(
		...
		std::vector<std::shared_ptr<ObjectAction>>{
			std::make_shared<LaserAction>(actions_3[0], actions_3[1], Globals::pirate_laser_origin_left, c1, 2500),
			std::make_shared<LaserAction>(actions_3[2], actions_3[3], Globals::pirate_laser_origin_right, c1, 2500),
			std::make_shared<LaserAction>(actions_3[4], actions_3[5], Globals::pirate_laser_origin_left, c1, 2500),
			std::make_shared<LaserAction>(actions_3[6], actions_3[7], Globals::pirate_laser_origin_right, c1, 2500),
			std::make_shared<LaserAction>(actions_3[8], actions_3[9], Globals::pirate_laser_origin_left, c1, 2500),
			std::make_shared<LaserAction>(actions_3[10], actions_3[11], Globals::pirate_laser_origin_right, c1, 2500),
			std::make_shared<LaserAction>(actions_3[12], actions_3[13], Globals::pirate_laser_origin_left, c1, 2500),
			std::make_shared<LaserAction>(actions_3[14], actions_3[15], Globals::pirate_laser_origin_right, c1, 2500),
			std::make_shared<LaserAction>(actions_3[16], actions_3[17], Globals::pirate_laser_origin_left, c1, 2500),
			std::make_shared<LaserAction>(actions_3[18], actions_3[19], Globals::pirate_laser_origin_right, c1, 2500),
